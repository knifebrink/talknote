    ...
    <el-card class="login-form-layout">
      <el-form autoComplete="on"
        ...
        <div style="text-align: center">
          <svg-icon icon-class="user" style="width: 56px;height: 56px;color: #409EFF"></svg-icon>
        </div>
        <h2 class="login-title color-main">talk</h2>
        ...
        this.$refs.loginForm.validate(valid => {
          if (valid) {
            ...
            this.$store.dispatch('Login', this.loginForm).then(() => {
              ...
              this.$router.push({path: '/pgms/pages/'+this.loginForm.username})
            }).catch(() => {
